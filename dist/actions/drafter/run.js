import { C as setFailed, S as info, a as getGitHubAdapter, g as stringbool, h as string, i as actionLogger, m as object, n as sharedInputSchema, o as getRepository, s as escapeStringRegexp, w as setOutput, x as getInput, y as context } from "../../chunks/config.js";
import { _ as getVersionResolverCategories, a as getMinor, c as increment, d as satisfies, f as tryParse$1, g as getChangelogCategories, h as filterPullRequestsByPreCategories, i as getMajor, l as normalize, m as evaluateCategories, n as mergeInputAndConfig, o as getPatch, p as commonConfigSchema, r as coerce, s as getPrerelease, t as getReleaseDrafterConfig, u as normalizeRange, v as needsPullRequestChangedFiles } from "../../chunks/get-release-drafter-config.js";
...
var VersionDescriptor = class VersionDescriptor {
	...
	toSemver(version) {
		...
		const parsedVersion = tryParse$1(version);
		if (parsedVersion) return parsedVersion;
		const coercedVersion = coerce(version);
		return coercedVersion ? tryParse$1(coercedVersion) : null;
	}
...
var draftRelease = async (params) => {
	...
	if (!adapter.capabilities.draftReleases && !input.publish) {
		if (!input.dryRun) logger.info("The forge does not support draft releases; calculating the release without writes because publish is false.");
		input = {
			...input,
			dryRun: true
		};
