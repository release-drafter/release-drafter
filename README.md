...
|  `discussion-category-name` |  If specified, a discussion of the specified category is created and linked to the release. The value must be a category that already exists in the repository. Note: Only works with publish: true                                                                                                                                                                  |
...
| `discussion_url` | The URL to the discussion if one is created |
