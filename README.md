...
1. Only update the existing draft if the body looks like one previously generated by Release Drafter. This means it'll stop updating the draft if the body is modified, and prevent any other random draft being changed.
1. Support more than 250 commits (switch from Compare API to Commit List API)
