  ...
  update_release_draft:
    ...
    steps:
      ...
      - uses: release-drafter/release-drafter@v6
        ...
        #   config-name: repo:org/shared-configs/.github/release-drafter.yml@main
...
| Input                   | Description                                                                                                                                                                                                                                                                                                                                                                                                      |
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `config-name`           | If your workflow requires multiple release-drafter configs it be helpful to override the config-name. The config should still be located inside `.github` as that's where we are looking for config files. You can also reference a config file from another GitHub repository using the format: `repo:owner/repo/path/to/file.yml@ref`. For example: `repo:org/shared-configs/.github/release-drafter.yml@main` |
