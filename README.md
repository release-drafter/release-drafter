...
| `latest`                   | Optional | Mark the draft release as latest release. Default `false`.                                                                                                                         |
...
| `latest`      | A boolean indicating whether the release being created or updated is latest.                                                                                                                                                                                                                                                                                       |
