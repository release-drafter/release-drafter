...
const invalidConfigs = [
	...
	[
		{ ...DEFAULT_CONFIG, 'category-template': ['## $TITLE'] },
		'Expected string',
	],
	[{ ...DEFAULT_CONFIG, 'category-template': null }, 'Expected string'],
	[
		{ ...DEFAULT_CONFIG, 'change-template': ['* $TITLE (#$NUMBER) @$AUTHOR'] },
		'Expected string',
	],
	[{ ...DEFAULT_CONFIG, 'change-template': null }, 'Expected string'],
	[{ ...DEFAULT_CONFIG, 'change-title-escapes': ['<_*'] }, 'Expected string'],
	[{ ...DEFAULT_CONFIG, 'change-title-escapes': null }, 'Expected string'],
