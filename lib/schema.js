...
const schema = (context) => {
  ...
  return Joi.object()
    .keys({
      ...
      'include-commits': Joi.boolean().default(
        DEFAULT_CONFIG['include-commits']
      ),
        ...
        .keys({
          major: Joi.object({
            ...
            'commit-types': Joi.array()
              ...
              .single()
              .default(
                DEFAULT_CONFIG['version-resolver']['major']['commit-types']
              ),
          }),
          minor: Joi.object({
            labels: Joi.array()
            ...
            'commit-types': Joi.array()
              ...
              .single()
              .default(
                DEFAULT_CONFIG['version-resolver']['minor']['commit-types']
              ),
          }),
          patch: Joi.object({
            labels: Joi.array()
            ...
            'commit-types': Joi.array()
              ...
              .single()
              .default(
                DEFAULT_CONFIG['version-resolver']['patch']['commit-types']
              ),
          }),
          default: Joi.string()
