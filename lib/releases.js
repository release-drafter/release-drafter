...
export const findReleases = async ({ ref, context, config }) => {
...
export const generateChangeLog = (mergedPullRequests, config) => {
...
export const createRelease = ({ context, releaseInfo }) => {
...
export const updateRelease = ({ context, draftRelease, releaseInfo }) => {
